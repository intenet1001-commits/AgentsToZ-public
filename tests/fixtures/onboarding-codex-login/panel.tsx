...
import OnboardingCodexLoginPanel from '../../../src/OnboardingCodexLoginPanel';
...
function Panel(){const [next,setNext]=useState(0);return <><OnboardingCodexLoginPanel transport={transport} onContinue={()=>setNext(n=>n+1)} /><output aria-label="next-step">{next}</output></>;}
