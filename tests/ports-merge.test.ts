...
import roleFixtures from './fixtures/project-role-merge.json';

for (const fixture of roleFixtures) {
  test(`role persistence: ${fixture.name}`, () => {
    const merge = () => fixture.base
      ? mergePortSnapshots(fixture.base, fixture.desired, fixture.current)
      : mergeLegacyPortSave(fixture.desired, fixture.current);
    if (fixture.error) expect(merge).toThrow('PROJECT_ROLE_INVALID');
    else expect(merge()).toEqual(fixture.expected!);
  });
}
