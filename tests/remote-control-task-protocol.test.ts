...
describe('remote-control v8 task request envelope', () => {
  test('is an explicit tasks-v1 scope over task-v2 without changing the base remote protocol', () => {
    expect(REMOTE_CONTROL_TASK_TRANSPORT_VERSION).toBe('agentstoz-local-v9');
