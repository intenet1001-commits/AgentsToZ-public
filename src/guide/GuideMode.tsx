    ...
    <>
      <div
        ...
        style={{
          ...
          zIndex: GUIDE_Z.banner, background: 'var(--bg-notice)', color:'var(--ink-e6f2f0)', padding: '8px 14px',
      ...
      >
        <GraduationCap size={14} style={{ color:'var(--ink-5eead4)' }} />
        <span style={{ color:'var(--ink-8ca39f)' }}>
          <span style={{ color:'var(--ink-5eead4)', fontWeight: 600 }}>안전 탐색 모드</span>
        ...
        <button
          ...
          style={{
            ...
            borderRadius: 5, fontSize: 11.5, fontWeight: 500, cursor: 'pointer', color:'var(--ink-5eead4)',
