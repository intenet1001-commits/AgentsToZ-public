        ...
        <div className="sticky top-0 z-10 flex items-start gap-3 border-b border-[rgb(var(--surface-highlight-rgb))]/[0.07] bg-[rgb(var(--bg-elevated-rgb))]/95 px-5 py-4 backdrop-blur">
          ...
          <div className="min-w-0">
            <div className="mb-1 flex flex-wrap items-center gap-2">
              <h2 id="buzz-agent-setup-title" className="m-0 text-base font-semibold text-zinc-100">{scope === "service" ? "프로젝트를 USE 서비스 Agent로 만들기" : "Buzz 범용 Agent 생성·연결"}</h2>
        ...
        <div className="space-y-4 p-5">
          <div className="rounded-xl border border-teal-300/15 bg-teal-300/[0.04] p-3 text-[11px] leading-5 text-zinc-300">
            <strong className="text-teal-200">역할 분리</strong> · {scope === "service"
              ? <>프로젝트 영역의 <span className="text-cyan-200">Buzz 채널</span>은 대화 공간을 열거나 프로젝트와 연결만 합니다. 이 화면에서 선택한 프로젝트를 USE 서비스 Agent로 만들고 별도 운영기억을 준비합니다.</>
            ...
            <>
              ...
              {scope === "service" ? (
                ...
                <div className="rounded-xl border border-violet-300/15 bg-violet-300/[0.035] p-3">
                  ...
                  <textarea readOnly value={instructions} aria-label="Buzz 범용 CS-CEO system prompt" className="mt-2 h-44 w-full resize-y rounded-lg border border-[rgb(var(--surface-highlight-rgb))]/10 bg-[rgb(var(--surface-shade-rgb))]/30 p-3 font-mono text-[10px] leading-4 text-zinc-300 outline-none" />
                </div>
              )}
