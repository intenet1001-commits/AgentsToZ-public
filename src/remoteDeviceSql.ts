/**
 * Canonical headless/cloud device enrollment schema.
 * Keep byte-for-byte SQL behavior aligned with
 * supabase/migrations/20260823000700_remote_device_enrollment.sql.
 */
export const REMOTE_DEVICE_SQL = String.raw`-- Headless hosts (AWS/Linux/containers) cannot open the desktop setup wizard.
