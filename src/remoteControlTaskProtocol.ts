...
/**
 * Additive remote-task transport. The base remote-control protocol remains separate and a base
 * session must never gain this protocol merely because the host was upgraded.
 */
export const REMOTE_CONTROL_TASK_TRANSPORT_VERSION = 'agentstoz-local-v9' as const;
