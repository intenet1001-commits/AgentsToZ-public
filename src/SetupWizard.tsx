...
export default function SetupWizard({ onComplete, onSkip, onStartProject, onStartControl, onOpenProjects, onOpenFirstTask, hasExistingDevice = false }: SetupWizardProps) {
