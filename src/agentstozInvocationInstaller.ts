...
export const AGENTSTOZ_INVOCATION_VERSION = 2;
...
- Submit durable operating decisions with \`agentstoz_use_propose_control_memory\`. A candidate is not a completed save; review happens in the AgentsToZ profile panel.
