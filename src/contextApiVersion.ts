...
export const LOCAL_API_HEALTH_PROOF_CONTRACT = Object.freeze({
  ...contract.sidecarHealthProof,
});
export const REMOTE_CONTROL_HEALTH_PROOF_CONTRACT = Object.freeze({
  ...contract.remoteControlHealthProof,
});
export const AGENT_RUNTIME_HEALTH_PROOF_CONTRACT = Object.freeze({
  ...contract.agentRuntimeHealthProof,
});
