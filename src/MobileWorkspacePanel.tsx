import {MobileTesterPanel} from './MobileTesterPanel';
...
export function MobileWorkspacePanel({mode,projects,available,online,transport,onDraft,visible=true,initialTarget,testerAvailable=false}: {
 testerAvailable?:boolean;mode:'records'|'manage';projects:QrRemoteControlProjectCard[];available:boolean;online:boolean;visible?:boolean;initialTarget?:string;
 ...
 return <section className="remote-panel mobile-workspace-panel">
  ...
  {mode==='manage'&&<MobileTesterPanel targetId={online&&!selected?'':target} available={testerAvailable} online={online} visible={visible} transport={transport}/>}
 </section>;
}
