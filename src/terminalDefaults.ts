export type TerminalApp = 'internal' | 'cmux' | 'orca' | 'iterm' | 'terminal' | 'powershell' | 'wsl';
...
export function isClaudeBgAvailable(
  ...
  if (app === 'powershell' || app === 'internal') return false;
...
export function tmuxReach(
  ...
  if (app === 'orca' || app === 'powershell' || app === 'internal') return 'none';
